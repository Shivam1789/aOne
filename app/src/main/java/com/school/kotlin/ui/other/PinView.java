...
/**
 * Created by khuspreet on 4/5/18.
 */
...
public class PinView extends AppCompatEditText {
    ...
    private void updatePaints() {
        mPaint.setColor(ContextCompat.getColor(getContext(),R.color.color_grey_view));  /* change the box color*/
        mPaint.setStyle(Paint.Style.STROKE);
        mPaint.setStrokeWidth(mLineWidth);
        mTextPaint.setColor(getCurrentTextColor());  /* change the text color pf input*/
    }
